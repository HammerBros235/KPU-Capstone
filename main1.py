...
# 비디오의 setting을 준비함.
cap = cv2.VideoCapture(0) #괄호 안의 숫자 0 or 1 내외장 카메라 구분
...
while True:
    ...
    faces = faceCascade.detectMultiScale( #이미지에서 얼굴을 검출
        ...
        minNeighbors=3, #최소 가질 수 있는 이웃 3~6사이의 값을 넣어야 detect가 더 잘된다고 한다.
    ...
    for (x,y,w,h) in faces: #좌표 값과 rectangular의 width height를 받게 된다.
        ...
        cv2.rectangle(img,(x,y),(x+w,y+h),(255,77,10),2) #안의 값은 정사각형의 테두리색 RGB값
